...
public class Materiau extends Composant {
    ...
    public Materiau(int id, String nom, TypeComposant typeComposant, double tauxTVA, double coutUnitaire, double quantite, double coutTransport, double coefficientQualite) {
